...
public class CustomProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    private static void drawHighLightRed(CustomProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo) {
    ...
    protected static CustomProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
        ...
        return new CustomProcessDiagramCanvas((int) maxX + 60, (int) maxY + 20, (int) minX, (int) minY,
