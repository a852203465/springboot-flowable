...
public class DefaultSvgProcessDiagramGenerator implements SvgProcessDiagramGenerator {
    ...
    public DefaultSvgProcessDiagramGenerator() {
        // start event
        activityDrawInstructions.put(StartEvent.class,
                new ActivityDrawInstruction() {

                    @Override
                    public void draw(DefaultSvgProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
        ...
        activityDrawInstructions.put(EventSubProcess.class,
                new ActivityDrawInstruction() {
                    ...
                    public void draw(DefaultSvgProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                        GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                        if (graphicInfo.getExpanded() != null && !graphicInfo.getExpanded()) {
                            processDiagramCanvas.drawCollapsedSubProcess(flowNode.getId(), flowNode.getName(), graphicInfo, true);
                        } else {
                            processDiagramCanvas.drawExpandedSubProcess(flowNode.getId(), flowNode.getName(), graphicInfo, EventSubProcess.class);
                        }
                    }
                });
        ...
        artifactDrawInstructions.put(TextAnnotation.class,
                new ArtifactDrawInstruction() {
                    @Override
                    public void draw(DefaultSvgProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
    ...
    @Override
    public InputStream generateDiagram(BpmnModel bpmnModel, List<String> highLightedActivities, List<String> highLightedFlows, String activityFontName, String labelFontName, String annotationFontName) {
    ...
    @Override
    public InputStream generateDiagram(BpmnModel bpmnModel, List<String> highLightedActivities, List<String> highLightedFlows, String activityFontName, String labelFontName, String annotationFontName, boolean generateDefaultDiagram) {
    ...
    protected InputStream getDefaultDiagram(String diagramImageFileName) {
        ...
        if (imageStream == null) {
            throw new FlowableImageException("Error occurred while getting default diagram image from file: " + imageFileName);
        }
        return imageStream;
    }
    ...
    @Override
    public InputStream generateDiagram(BpmnModel bpmnModel, String activityFontName, String labelFontName, String annotationFontName) {
        return generateDiagram(bpmnModel, Collections.emptyList(), Collections.emptyList(), activityFontName, labelFontName, annotationFontName);
    }

    protected DefaultSvgProcessDiagramCanvas generateProcessDiagram(BpmnModel bpmnModel, List<String> highLightedActivities, List<String> highLightedFlows, String activityFontName, String labelFontName, String annotationFontName) {
        prepareBpmnModel(bpmnModel);
        DefaultSvgProcessDiagramCanvas processDiagramCanvas = initProcessDiagramCanvas(bpmnModel, activityFontName, labelFontName, annotationFontName);
    ...
    protected void drawActivity(DefaultSvgProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode, List<String> highLightedActivities, List<String> highLightedFlows) {
     ...
     * @return
     */
    protected static List<GraphicInfo> connectionPerfectionizer(DefaultSvgProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, BaseElement sourceElement, BaseElement targetElement, List<GraphicInfo> graphicInfoList) {
        ...
        DefaultSvgProcessDiagramCanvas.SHAPE_TYPE sourceShapeType = getShapeType(sourceElement);
        DefaultSvgProcessDiagramCanvas.SHAPE_TYPE targetShapeType = getShapeType(targetElement);
     ...
     */
    protected static DefaultSvgProcessDiagramCanvas.SHAPE_TYPE getShapeType(BaseElement baseElement) {
        if (baseElement instanceof Task || baseElement instanceof Activity || baseElement instanceof TextAnnotation) {
            return DefaultSvgProcessDiagramCanvas.SHAPE_TYPE.Rectangle;
        } else if (baseElement instanceof Gateway) {
            return DefaultSvgProcessDiagramCanvas.SHAPE_TYPE.Rhombus;
        } else if (baseElement instanceof Event) {
            return DefaultSvgProcessDiagramCanvas.SHAPE_TYPE.Ellipse;
        }
    ...
    protected static GraphicInfo getLineCenter(List<GraphicInfo> graphicInfoList) {
        ...
        for (int i = 1; i < graphicInfoList.size(); i++) {
            ...
            length += Math.sqrt(
                    Math.pow((int) graphicInfo.getX() - (int) previousGraphicInfo.getX(), 2) + Math.pow((int) graphicInfo.getY() - (int) previousGraphicInfo.getY(), 2)
            );
            lengths[i] = length;
        }
        m = length / 2;
    ...
    protected void drawArtifact(DefaultSvgProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
    ...
    private static void drawHighLight(DefaultSvgProcessDiagramCanvas processDiagramCanvas,
                                      GraphicInfo graphicInfo) {
        processDiagramCanvas.drawHighLight((int) graphicInfo.getX(), (int) graphicInfo.getY(), (int) graphicInfo.getWidth(), (int) graphicInfo.getHeight());
    }

    private static void drawGreenHighLight(DefaultSvgProcessDiagramCanvas processDiagramCanvas,
                                           GraphicInfo graphicInfo) {
    ...
    protected static DefaultSvgProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String activityFontName, String labelFontName, String annotationFontName) {
        ...
        return new DefaultSvgProcessDiagramCanvas((int) maxX + 10, (int) maxY + 10, (int) minX, (int) minY, activityFontName, labelFontName, annotationFontName);
    }
    ...
    protected interface ActivityDrawInstruction {
        void draw(DefaultSvgProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode);
    }

    protected interface ArtifactDrawInstruction {
        void draw(DefaultSvgProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact);
    }
