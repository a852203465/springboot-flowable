...
import cn.darkjrong.workflow.flowable.image.svg.icon.*;
...
public class DefaultSvgProcessDiagramCanvas {
     ...
     */
    public DefaultSvgProcessDiagramCanvas(int width, int height, int minX, int minY, String activityFontName, String labelFontName, String annotationFontName) {
     ...
     *             below minX on the horizontal scale will be cropped.
     */
    public DefaultSvgProcessDiagramCanvas(int width, int height, int minX, int minY) {
        this.canvasWidth = width;
        this.canvasHeight = height;
        this.minX = minX;
        this.minY = minY;
